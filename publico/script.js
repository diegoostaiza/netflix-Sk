...
const chatFilePath = 'publico/pages/chat.html';
  ...
  chat.addEventListener('click', () => {
    ...
    if (screenWidth < 768) {
      ...
      function createNode() {
        ...
        e_17.setAttribute("src", `publico/imgs/friends/${imageName}.${imageFormat}`);
        ...
        e_29.setAttribute("src", "publico/imgs/lock.svg");
...
if (intSettingBtn !== null) {
  intSettingBtn.addEventListener('click', ()=> {
        ...
        function createSettingsPage() {
          ...
          e_24.setAttribute("src", "publico/imgs/my-profile-pic.jpg");
          ...
          e_29.setAttribute("src", "publico/imgs/qr-code.png");
